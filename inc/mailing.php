		...
		function ra_get_footer_email(){
			$footer ='</td></tr><tr><td>
					...
					<table width="184" cellspacing="0" cellpadding="0" border="0" align="right">
						<tr>
							<td>
								<a target="_blank" href="https://www.facebook.com/zoho"><img width="8" height="16" style="line-height:0px;font-size:0px;border:0px;margin-left:20px;padding:3px" src="https://www.zoho.com/docs/images/email-templates/facebook.png" alt="img" class="CToWUd"></a>
								...
								<a target="_blank" href="https://www.linkedin.com/groups/ZOHO-Docs-2125232"><img width="15" height="15" style="line-height:0px;font-size:0px;border:0px;margin-left:20px;padding:3px" src="https://www.zoho.com/docs/images/email-templates/linkedin.png" alt="img" class="CToWUd"></a>
							</td>
						</tr>
					</table>
				</td>
